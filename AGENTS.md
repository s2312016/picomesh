...
PicoMesh is a reusable embedded distributed-systems framework extracted from general infrastructure developed for AETERNA.

## Mandatory boundaries

- Do not copy AETERNA datasets, trained model weights, inference implementations, learned voting parameters, unpublished fault-tolerance algorithms, or board-production files.
- Generalize reusable communication and node-management concepts instead of preserving AETERNA names or fixed topology assumptions.
